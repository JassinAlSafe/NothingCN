    ...
    <div className={cn("space-y-6", className)}>
      ...
      {(title || description) && (
        <div className="space-y-3">
          ...
          {description && (
            <p className="text-muted-foreground leading-relaxed ml-4">{description}</p>
          )}
        </div>
      )}
      ...
      <Card className="overflow-hidden">
        <Tabs defaultValue="preview" className="w-full">
          ...
          <TabsContent value="preview" className="mt-0 border-0 p-0">
            <div className="min-h-[300px] flex items-center justify-center p-8 bg-gradient-to-br from-background to-muted/20">
